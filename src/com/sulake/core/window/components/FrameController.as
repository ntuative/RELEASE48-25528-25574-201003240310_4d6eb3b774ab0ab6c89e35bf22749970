package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1050:String = "_HEADER";
      
      private static const const_752:String = "margin_right";
      
      private static const const_1048:String = "_SCALER";
      
      private static const const_1047:String = "_TITLE";
      ...
      private var var_1135:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_753,_loc3_.left,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_754,_loc3_.top,PropertyStruct.const_60,_loc2_));
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_263);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1135 == null)
         {
            var_1135 = findChildByTag(const_1050) as IHeaderWindow;
            if(!var_1135)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1047) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1048) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_276,false);
         }
      ...
      public function get content() : IWindowContainer
      {
         if(var_19 == null)
         {
            var_19 = findChildByTag(const_1049) as IWindowContainer;
            if(!var_19)
            {
