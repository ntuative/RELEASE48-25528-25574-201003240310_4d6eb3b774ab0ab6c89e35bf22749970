package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1402:uint = 500;
      ...
      protected var var_937:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_447 = new Array();
         var_447[0] = MouseCursorType.const_317;
         var_447[1] = MouseCursorType.const_39;
         var_447[2] = MouseCursorType.const_317;
         var_447[3] = MouseCursorType.const_317;
         var_447[4] = MouseCursorType.const_39;
         var_447[5] = MouseCursorType.const_39;
         var_447[6] = MouseCursorType.const_317;
         if(var_327 == null)
         {
            var_327 = new Array();
            var_327[0] = WindowState.const_93;
            var_327[1] = WindowState.const_71;
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         ...
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_908,param1.toolTipDelay != const_1402));
         return param2;
      }
      ...
      {
         var_938 = param1 == null ? const_743 : param1;
      }
