package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1062:String = "content";
      
      private static const const_1061:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1602 == null)
         {
            var_1602 = findChildByTag(TabContextController.const_1062) as IWindowContainer;
         }
         return var_1602;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_933 == null)
         {
            var_933 = findChildByTag(TabContextController.const_1061) as ITabSelectorWindow;
            if(var_933 != null)
            {
      ...
      {
         return !!var_912 ? selector.iterator : null;
      }
