package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1404:Boolean = false;
      ...
      protected var var_1102:Boolean = false;
      ...
      protected var var_760:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_161 = var_627 || !testParamFlag(WindowParam.const_32);
         _container = var_14.create("_CONTAINER","",WindowType.const_309,WindowStyle.const_298,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_45,containerEventHandler);
         _container.addEventListener(WindowEvent.const_482,containerEventHandler);
      ...
      {
         return new Rectangle(var_537 * maxScrollH,var_536 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_482,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_537 = param1;
            _container.x = -var_537 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1032,_spacing,PropertyStruct.const_60,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1030,var_760,PropertyStruct.const_56,var_760 != const_1403));
         _loc1_.push(new PropertyStruct(const_1031,var_538,PropertyStruct.const_56,var_538 != const_1404));
         _loc1_.push(new PropertyStruct(const_1029,var_1102,PropertyStruct.const_56,var_1102 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1029:
                  ...
                  break;
               case const_1030:
                  var_760 = _loc2_.value as Boolean;
                  break;
            }
         }
