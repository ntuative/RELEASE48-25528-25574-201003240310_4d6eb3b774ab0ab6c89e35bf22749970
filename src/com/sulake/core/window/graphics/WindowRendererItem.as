package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_781:uint = 1;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_402:
               ...
               break;
            case WindowRedrawFlag.const_867:
               var_715 = var_649.getTheActualState(param1.type,param1.style,param1.state);
               if(var_715 != var_1034)
               {
                  var_233 = true;
                  _loc4_ = true;
            ...
            case WindowRedrawFlag.const_842:
               ...
               break;
            case WindowRedrawFlag.const_275:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_649.getTheActualState(param1.type,param1.style,param1.state) != var_1034;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc11_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_782) : uint(const_494);
         var _loc7_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(var_715))
            {
               _loc5_ = const_781;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_781)
               {
                  ...
                  if(var_233)
                  {
                     ...
                     _loc7_.draw(param1,var_91,var_91.rect,var_715,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_91,var_934,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_649.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_927)
            {
               _loc2_ = var_649.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_927);
            }
         }
         return _loc2_;
      }
