package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_760:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1713 = new Dictionary();
         TypeCodeTable.fillTables(var_1411,var_1713);
         var_1153 = new Dictionary();
         var_1712 = new Dictionary();
         StateCodeTable.fillTables(var_1153,var_1712);
         var_463 = new Dictionary();
         var_463["skin"] = BitmapSkinRenderer;
         var_463["bitmap"] = BitmapDataRenderer;
         var_463["fill"] = FillSkinRenderer;
         var_463["text"] = TextSkinRenderer;
         var_463["shape"] = ShapeSkinRenderer;
         var_463["unknown"] = SkinRenderer;
         var_463["null"] = NullSkinRenderer;
         if(var_374 == null)
         {
            var_374 = new Array();
            var_374.push(WindowState.const_61);
            ...
            var_374.push(WindowState.const_71);
            var_374.push(WindowState.const_93);
            var_374.push(WindowState.const_88);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1153)
         {
            _loc3_.push(var_1153[_loc4_]);
         }
         if(param1 != null)
         {
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_656[param1] = new Array(SkinContainer.const_760);
         }
         var_656[param1][param2] = param3;
         if(true)
         {
            var_657[param1] = new Array(SkinContainer.const_760);
         }
         var_657[param1][param2] = param4;
      }
