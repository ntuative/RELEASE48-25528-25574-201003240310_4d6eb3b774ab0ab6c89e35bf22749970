package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_408 = _loc13_.blend;
            var_534 = _loc13_.treshold;
            if(var_627 != _loc13_.background)
            {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc2_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_143);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
      ...
      {
         var_627 = param1;
         var_533 = !!var_627 ? uint(var_533 | var_1373) : uint(var_533 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2096 + "]";
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_978;
         update(this,_loc1_);
         return true;
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_607,var_7);
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_803;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_408 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_842);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1056 || _loc3_.hasGraphicsContext())
         {
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_533 = !!var_627 ? uint(param1) : uint(param1 & 16777215);
         var_14.invalidate(this,var_7,WindowRedrawFlag.const_70);
      }
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_895;
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_263))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_263))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_174:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_396,this,null));
                     if(testParamFlag(WindowParam.const_163,WindowParam.const_142))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_154,WindowParam.const_143))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_451:
                  var_14.invalidate(this,var_7.union(var_54),WindowRedrawFlag.const_402);
                  if(param1 == this)
                  {
               ...
               case WindowNotifyEvent.const_296:
                  if(param1 == this)
                  {
                     ...
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_216,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_363:
                  var_14.invalidate(this,var_7,WindowRedrawFlag.const_867);
                  break;
               case WindowNotifyEvent.const_452:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_397:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_14.invalidate(this,var_7,WindowRedrawFlag.const_402);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_216:
                  ...
                  break;
               case WindowNotifyEvent.const_396:
                  var_8.getRegionProperties(null,var_311);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_331:
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_818;
         update(this,_loc1_);
         return true;
      }
      ...
      public function maximize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_61,true);
         _loc1_.type = WindowNotifyEvent.const_912;
         update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_296;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1056 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_717,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_61,true);
         _loc1_.type = WindowNotifyEvent.const_1336;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_161 && var_534 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_7.width && param1.y <= var_7.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1545,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1545,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1250,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            if(var_8 != null)
            {
               var_311 = var_8.rectangle.clone();
               var_54.x = var_7.x;
               var_54.y = var_7.y;
               var_54.width = var_7.width;
               var_54.height = var_7.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_463,this,var_8));
            }
            else
            {
               var_311.x = 0;
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_397,this,null));
         }
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_517;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_431;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_31 == WindowState.const_466)
         {
            return true;
         }
         var_31 = WindowState.const_466;
