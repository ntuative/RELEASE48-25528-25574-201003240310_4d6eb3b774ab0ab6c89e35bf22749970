package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_847:String = "_EXCLUDE";
      ...
      protected var var_1111:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_940:Dictionary;
      
      protected var var_1378:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1110,var_1111);
         var_940 = new Dictionary();
         var_1379 = new Dictionary();
         ParamCodeTable.fillTables(var_940,var_1379);
         var_1378 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_1111)
            {
               delete var_1111[_loc1_];
            }
            for(_loc1_ in var_940)
            {
               delete var_940[_loc1_];
            }
            for(_loc1_ in var_1379)
            {
               delete var_1379[_loc1_];
            }
            var_1378.dispose();
            var_1378 = null;
            var_14 = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_847) == -1)
                  {
