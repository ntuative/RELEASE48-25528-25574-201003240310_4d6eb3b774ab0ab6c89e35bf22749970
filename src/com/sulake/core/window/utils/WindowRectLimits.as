package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_434:int = -2147483648;
      
      private var var_433:int = 2147483647;
      ...
      {
         return var_432 == int.MIN_VALUE && var_433 == int.MAX_VALUE && var_434 == int.MIN_VALUE && var_431 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_433 = param1;
         if(var_433 < int.MAX_VALUE && true && _target.width > var_433)
         {
      ...
      public function setEmpty() : void
      {
         ...
         var_433 = int.MAX_VALUE;
         var_434 = int.MIN_VALUE;
      ...
      {
         var_434 = param1;
         if(var_434 > int.MIN_VALUE && true && _target.height < var_434)
         {
