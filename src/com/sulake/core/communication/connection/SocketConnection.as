package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1335:int = 10000;
      ...
      private var var_682:IEncryption;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_74 = new Socket();
         var_350 = new Timer(const_1335,1);
      ...
      {
         var_350.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_681));
      ...
      {
         var_350.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_681));
      ...
      private function onConnect(param1:Event) : void
      {
         var_350.stop();
         var_1221 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_681));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc5_:ByteArray = var_580.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_348)
         {
         ...
         if(var_682 != null)
         {
            _loc3_ = var_682.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_349.writeByte(var_74.readUnsignedByte());
         }
      }
      ...
      {
         var_350.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_681));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_580.getMessages(var_349,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_834.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
      ...
      {
         var_350.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_681));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_350.stop();
         var_1221 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_681));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_682 + "\n");
      }
   }
}
