package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_593:uint = 0;
      
      public static const const_872:String = "AssetLibraryReady";
      
      public static const const_1241:String = "AssetLibraryUnloaded";
      
      public static const const_454:String = "AssetLibraryLoaded";
      
      public static const const_1239:String = "AssetLibraryLoadError";
      ...
      private var var_506:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_593;
         var_411 = new Dictionary(false);
         var_410 = new Dictionary(false);
         var_713 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_411)
         {
            _loc4_ = AssetTypeDeclaration(var_411[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_410)
         {
            _loc2_ = var_410[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_410[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_713)
         {
            delete var_713[_loc1_];
         }
         if(var_15 != null)
         {
            var_15.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_506)
         {
            AssetLibrary.fetchLibraryContents(this,var_507,var_359);
         }
         var_309 = true;
         dispatchEvent(new Event(AssetLibrary.const_454));
         dispatchEvent(new Event(AssetLibrary.const_872));
         if(var_506)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_410[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_950,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_921,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_810,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_410[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_411.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_411[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1239));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_411[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_410[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_411[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
