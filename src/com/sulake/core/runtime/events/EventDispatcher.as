package com.sulake.core.runtime.events
{
   ...
   public class EventDispatcher implements IEventDispatcher, IDisposable
   {
      ...
      private static const const_767:uint = 2;
       
      
      private var var_673:Error;
      ...
      public function dispatchEvent(param1:Event) : Boolean
      {
         if(!_disposed)
         {
            ...
            if(_result == const_767)
            {
               if(var_673 != null)
               {
                  Core.crash("Error catched in EventDispatcher: undefined",var_673.errorID,var_673);
               }
               else
               {
                  Core.crash("Error catched in EventDispatcher. No error data available!",0,var_673);
               }
            }
      ...
      private function eventProcessor(param1:Event) : void
      {
         ...
         _result = !!event.isDefaultPrevented() ? uint(const_1077) : uint(const_491);
      }
