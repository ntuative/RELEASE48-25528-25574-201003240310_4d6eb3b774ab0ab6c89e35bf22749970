package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_366.shockwaveClientUrl = var_115.shockwaveClientUrl;
         var_366.ssoTicket = var_115.ticket;
         var_115.removeEventListener(SSOTicket.const_306,onParsedTicketSuccess);
         var_115.removeEventListener(SSOTicket.const_234,onParsedTicketFailure);
         var_115 = null;
      ...
      private function createWindow() : void
      {
         ...
         _window = var_366.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_476,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_115 = new SSOTicket(var_366.assets,_loc2_,_loc1_);
         var_115.addEventListener(SSOTicket.const_306,onParsedTicketSuccess);
         var_115.addEventListener(SSOTicket.const_234,onParsedTicketFailure);
      }
