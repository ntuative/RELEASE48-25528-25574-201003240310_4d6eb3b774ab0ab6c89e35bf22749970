package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2215:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1584:ILogger;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_1284:
            case DisconnectReasonEvent.const_1150:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_1267:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_1376:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2217)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_752 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_752);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1358,var_2216));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2215);
      ...
      {
         var_752 = _habboConfiguration.getKey("sso.ticket",null);
         var_1358 = _habboConfiguration.getKey("flash.client.url","");
         var_2216 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_178 == null)
         {
         ...
         if(var_752 != null)
         {
            var_64.mode = HabboConnectionType.const_417;
            var_64.initConnection(HabboConnectionType.const_243);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1584 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_714);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2215 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_64.mode)
         {
            case HabboConnectionType.const_417:
               ...
               var_1088 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1088,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_823:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1333:
               var_621 = generateRandomHexString(30);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_64.mode = HabboConnectionType.const_823;
            }
         }
         var_64.initConnection(HabboConnectionType.const_243);
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_99,onRoomSessionEnded);
      }
