package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_113,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_931,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_392,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_516,onDisplayWindowEvent);
