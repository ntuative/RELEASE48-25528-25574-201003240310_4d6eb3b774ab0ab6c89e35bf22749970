package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      {
         return var_1264 == false && var_706 == 1 && var_1352 != var_31;
      }
      ...
      {
         var _loc2_:* = null;
         if(var_52 <= var_863.length)
         {
            _loc2_ = var_863[var_52];
