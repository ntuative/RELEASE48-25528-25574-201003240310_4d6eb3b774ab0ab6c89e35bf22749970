package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1054:Number = 90;
      
      private static const const_750:int = 50;
      
      private static const const_1044:Number = 25;
      
      private static const const_1045:int = 50;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_453.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_453.splice(_loc3_,1);
            var_452.splice(_loc3_,1);
         }
         var_452.push(param1.name);
         var_453.push(param2);
         param1.addEventListener(WindowEvent.const_441,windowEventListener);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:MenuAnimatorItem = method_2(param1);
         if(_loc3_ == null)
         {
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_546[_loc3_] = new Array();
            }
            if(var_546[_loc3_].indexOf(param1) < 0)
            {
               var_546[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_750 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_750 || param1.desktop.height - param1.y < const_1045;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_452[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_546[_loc3_].length)
                  {
                     repositionWindow(var_546[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function method_2(param1:String) : MenuAnimatorItem
      {
