package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_103:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_724,_loc2_.userName));
               break;
      ...
      {
         return [RoomSessionDoorbellEvent.const_103,RoomSessionDoorbellEvent.const_110,RoomSessionDoorbellEvent.const_52];
      }
