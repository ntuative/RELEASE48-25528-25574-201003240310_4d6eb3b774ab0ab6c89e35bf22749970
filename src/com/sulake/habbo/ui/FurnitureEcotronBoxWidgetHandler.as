package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_524,RoomWidgetEcotronBoxOpenMessage.const_578,RoomWidgetEcotronBoxOpenedMessage.const_1313];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_524:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_578:
