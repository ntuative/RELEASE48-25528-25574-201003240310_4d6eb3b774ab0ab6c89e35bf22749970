package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_364:
               ...
               {
                  case RoomSessionQueueEvent.const_840:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc7_.length > 1)
               {
                  ...
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1152) + 1;
                  }
               }
               else
               {
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.const_704:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_840);
               break;
      ...
      {
         return [RoomSessionQueueEvent.const_364];
      }
