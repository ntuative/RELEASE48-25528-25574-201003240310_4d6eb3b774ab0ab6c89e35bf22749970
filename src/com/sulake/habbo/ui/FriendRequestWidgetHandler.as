package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_520);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_582);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_653);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_520:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_582:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_653:
