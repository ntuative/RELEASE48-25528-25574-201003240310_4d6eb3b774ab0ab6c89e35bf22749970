package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_928:IHabboHelp = null;
      ...
      private var var_1946:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_328,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_385,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_636,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_690 = _roomEngine.loadRoomResources(var_36.roomResources);
            if(false)
            {
               var_1234 = false;
         ...
         {
            var_1233 = !var_284.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_36.roomId,var_36.roomCategory,var_264[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_328,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_385,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_636,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_18 = null;
         var_843 = null;
         ...
         if(var_192 && false)
         {
            var_192.events.removeEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            var_192.events.removeEventListener(HabboToolbarEvent.const_54,onHabboToolbarEvent);
         }
         var_192 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1946);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_192 != null)
         {
            var_166.toolbarSize = var_192.size;
            var_166.toolbarOrientation = var_192.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_525:
               ...
               if(var_757 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_36.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_404)
                  {
                     var_757.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_539,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
            ...
            case RoomEngineObjectEvent.const_114:
               ...
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.const_377:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_526);
            _loc13_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_621);
            _loc14_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_567);
            _loc15_ = _roomEngine.getRoomNumberValue(var_36.roomId,var_36.roomCategory,RoomVariableEnum.const_657);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_287);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_380:
               ...
               var_167 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_333,WindowStyle.const_298,WindowParam.const_87) as IToolTipWindow;
      ...
      {
         if(var_690 == null || false)
         {
            return;
         }
         var _loc2_:int = var_690.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      {
         if(var_18 != null && var_36 != null && var_1233 && var_1234)
         {
