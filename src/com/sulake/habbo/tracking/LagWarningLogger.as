package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1131 || var_1391 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1392 == 0 || _loc1_ - var_1392 > var_1391)
         {
            if(_connection != null)
            {
      ...
      {
         var_1131 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1391 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
