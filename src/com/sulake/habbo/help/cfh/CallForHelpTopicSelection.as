package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_749 == null || _loc3_ < 0 || _loc3_ >= var_749.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_749[_loc3_];
            main.showUI(HabboHelpViewEnum.const_557);
            main.tellUI(HabboHelpViewEnum.const_557,null);
         }
      }
   }
}
