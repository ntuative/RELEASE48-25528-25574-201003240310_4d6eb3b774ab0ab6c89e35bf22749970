package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1555:uint = 13232628;
      
      private static var var_2149:uint = 11129827;
      ...
      private var var_899:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         _main.localization.registerParameter("help.tutorial.name.available","name",var_422);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_ok":
                  ...
                  break;
               case "button_cancel":
                  _main.showView(TutorialUI.const_84);
                  break;
               case "button_usecurrent":
                  var_422 = _main.myName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            _main.localization.registerParameter("help.tutorial.name.confirmation","name",var_422);
         }
         if(var_279 == null)
         {
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1598:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1599:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1599 || param1 == ChangeUserNameResultMessageEvent.var_1598)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_899 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_899.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1555;
