package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1434:uint = 4.294967295E9;
      
      private const const_1435:uint = 4.293848814E9;
      
      private var var_789:int;
      
      private const const_1639:uint = 4.291613146E9;
      ...
      {
         return param1 % 2 == 0 ? uint(const_1435) : uint(const_1434);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_565,var_75,var_956);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_246) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(var_549[var_184]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_550[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_565,var_75,var_956,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1404 = _loc1_.stuffTypes;
            var_549 = _loc1_.boxTypes;
            var_550 = _loc1_.ribbonTypes;
            var_788 = var_1404[0];
            var_184 = var_549[0];
            _ribbonIndex = var_550[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(var_246) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_246);
         }
         var_246 = param1;
         if(var_246 < 0)
         {
            var_246 = _loc2_.numListItems - 1;
         }
         if(var_246 >= _loc2_.numListItems)
         {
            var_246 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_246) as IWindowContainer;
