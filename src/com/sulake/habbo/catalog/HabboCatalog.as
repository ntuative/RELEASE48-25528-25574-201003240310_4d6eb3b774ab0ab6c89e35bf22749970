package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_428:ICatalogNavigator;
      ...
      private var var_2175:GiftWrappingConfiguration;
      ...
      private var var_1077:ClubGiftController;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2177 && var_519 != null)
         {
            var_519.playSound(HabboSoundTypesEnum.const_1020);
         }
         var_2177 = false;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_97:
               var_1338 = param1.session.isPrivateRoom;
               if(var_85 != null)
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2175 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_192.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1077.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function method_5() : void
      {
         ...
         var_428 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1077 == null)
         {
            var_1077 = new ClubGiftController(this);
         }
      }
      ...
      {
         var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_428.buildCatalogIndex(_loc2_);
         if(var_1076 != "")
         {
            var_428.openPage(var_1076);
            var_1076 = "";
         }
         else
         {
            var_428.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2176 && var_519 != null)
         {
            var_519.playSound(HabboSoundTypesEnum.const_806);
         }
         var_2176 = false;
      }
