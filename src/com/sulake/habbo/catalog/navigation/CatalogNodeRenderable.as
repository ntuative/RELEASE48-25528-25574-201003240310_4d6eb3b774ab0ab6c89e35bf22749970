package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1417:XML;
      ...
      private var var_1416:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1417 == null)
         {
            ...
            var_1417 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1416 == 4294967295)
            {
               var_1416 = _loc1_.color;
            }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1418) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_48 = navigator.catalog.windowManager.buildFromXML(var_1417) as IItemListWindow;
         if(var_48 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1207;
            }
         }
      }
