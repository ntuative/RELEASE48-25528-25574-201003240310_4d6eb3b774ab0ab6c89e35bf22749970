package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_2199:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1532,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_2085 || param1.furniTypeId != var_2084)
         {
            return;
         }
         var_2199 = param1;
      ...
      public function redeemSoldOffers() : void
      {
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc3_.status == MarketPlaceOfferState.const_383)
            {
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_2104 = _loc3_.creditsWaiting;
         var_205 = new Map();
      ...
      {
         requestOffers(var_2198,var_2200,var_2067,var_2201);
      }
