package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1546)
         {
            case RecyclerStatusMessageEvent.const_1219:
               ...
               break;
            case RecyclerStatusMessageEvent.const_977:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1305:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1546 != RecyclerStatusMessageEvent.const_977;
      }
      
      private function get statusActive() : Boolean
      {
         return var_276 != const_784;
      }
      ...
      {
         return active && var_276 == const_348;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1023:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1351:
