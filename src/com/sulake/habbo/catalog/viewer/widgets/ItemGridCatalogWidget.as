   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_589,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_266,activateScrollbar);
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_774 >= 0 && var_774 < page.offers.length)
            {
               _loc4_ = page.offers[var_774];
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++var_1397;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1397);
         }
      }
