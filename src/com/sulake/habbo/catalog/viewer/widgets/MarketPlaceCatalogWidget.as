package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_814:MarketPlaceOfferData;
      
      private const const_1419:int = 1;
      
      private const const_1644:int = 40;
      ...
      private function showDetails(param1:MarketPlaceOfferData) : void
      {
         ...
         {
            _loc9_ = method_3(param1.furniId,param1.furniType);
      ...
      private function updateList() : void
      {
         ...
         if(!var_391)
         {
            var_391 = new Timer(25);
            var_391.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_813 = 0;
         populateList();
         var_391.start();
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_390.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_391)
         {
            var_391.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_391 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_813 >= var_567.length)
            {
               return true;
            }
            addListItem(var_567.getWithIndex(var_813));
            ++var_813;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_814.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_390));
            _loc7_.selection = 0;
         }
      }
