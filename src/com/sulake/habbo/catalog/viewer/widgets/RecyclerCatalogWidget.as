package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_244:CatalogObjectMover;
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_30:
               if(var_244 != null)
               {
                  var_244.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(var_244 == null)
               {
                  var_244 = new CatalogObjectMover();
                  var_244.mainContainer = window;
                  var_244.roomEngine = _loc3_;
               }
               var_244.onMainContainerEvent(param1,param2,_loc4_);
         }
      }
