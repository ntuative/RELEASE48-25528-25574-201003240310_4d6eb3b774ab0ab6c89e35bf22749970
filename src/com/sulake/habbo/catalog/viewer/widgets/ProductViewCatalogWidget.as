package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_595:IItemGridWindow;
      
      private var var_81:IBitmapWrapperWindow;
      
      private var var_1159:ITextWindow;
      
      private var var_1280:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_595 != null)
         {
            var_595.visible = false;
            var_595.destroyGridItems();
         }
         if(var_1280 != null)
         {
         ...
         if(_loc3_ != null)
         {
            ...
            var_1158.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1159.text = "${" + _loc2_.localizationId + "}";
            var_1158.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_379:
                  _loc4_ = var_1279.clone();
                  if(var_595 != null)
                  {
                     var_595.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_595,var_1280,var_1230);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_215:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_299,AvatarAction.const_715);
                              _loc13_.appendAction(AvatarAction.const_593,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1158 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1519 = new Point(var_81.x,var_81.y);
         var_595 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1280 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_595 == null)
         {
         ...
         var_1279 = _loc2_.content as BitmapData;
