package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_998 != null)
         {
            var_998.removeEventListener(WindowKeyboardEvent.const_137,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_998 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_998 != null)
         {
            var_998.addEventListener(WindowKeyboardEvent.const_137,windowKeyEventProcessor);
         }
      }
