package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_559[var_967] as Array;
      ...
      {
         var _loc2_:Offer = var_559[var_967][var_1734];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_435 || _loc1_.pricingModel == Offer.const_471)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_76 || _loc3_.productType == ProductTypeEnum.const_80)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_966.indexOf(_loc5_) == -1)
                        {
                           var_966.push(_loc5_);
                           var_559.push(new Array());
                        }
                        _loc6_ = var_966.indexOf(_loc5_);
                        (var_559[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_559)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_559)
         {
            if(var_1734 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1734] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_967 = var_930.getGridItemIndex(param1.view);
