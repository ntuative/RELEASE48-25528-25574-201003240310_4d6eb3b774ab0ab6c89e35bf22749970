package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1017 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1017 != null)
         {
            var_1017.addEventListener(WindowKeyboardEvent.const_595,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1017.text));
      }
   }
}
