package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1218:IProductData;
      ...
      {
         super();
         var_1220 = param1.productType;
         var_1217 = param1.furniClassId;
         var_1003 = param1.extraParam;
         var_1002 = param1.productCount;
         var_1219 = param1.expiration;
         var_1218 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_76:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1003);
               break;
