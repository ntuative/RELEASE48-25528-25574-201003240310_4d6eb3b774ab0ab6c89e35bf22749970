package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1315:EventDispatcher;
      ...
      {
         return _localization.hasLinks(var_890);
      }
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1315;
            _loc2_.init();
         }
         var_1315.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1315.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_890);
      }
