package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1439:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_565 != null)
         {
            if(var_565.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_565.window);
            var_565.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1439);
         var_565 = _loc5_;
      ...
      {
         return var_565.dispatchWidgetEvent(param1);
      }
