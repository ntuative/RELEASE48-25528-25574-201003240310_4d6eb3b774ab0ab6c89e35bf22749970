package com.sulake.habbo.session.handler
{
   ...
   public class RoomSessionHandler extends BaseHandler
   {
      ...
      public static const const_972:String = "RS_CONNECTED";
      
      public static const const_671:String = "RS_DISCONNECTED";
      
      public static const const_995:String = "RS_READY";
      ...
      public function RoomSessionHandler(param1:IConnection, param2:IRoomHandlerListener)
      {
         ...
         param1.addMessageEvent(new CloseConnectionMessageEvent(method_8));
      ...
      private function method_8(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_671);
         }
      }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            ...
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_995);
         }
      }
      ...
      private function onRoomConnected(param1:IMessageEvent) : void
      {
         ...
         if(listener)
         {
            listener.sessionUpdate(_loc2_,_loc3_,RoomSessionHandler.const_972);
         }
      }
   }
}
