package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1027:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_589 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_589.width;
         var_90 = var_589.height;
         var_1026 = param5;
         var_867 = param6;
         var_232 = Math.floor(var_1026 / _thumbWidth);
         var_17 = new BitmapData(var_1026,var_867);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_17.height < var_867)
         {
            _loc12_ = new BitmapData(var_17.width,var_867);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_589.width,var_589.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_589.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_589,var_589.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1027 != null)
         {
            _loc1_ = var_1027.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_503 = resolveRowCountFromList();
         if(var_503 == 0)
         {
            var_17 = new BitmapData(var_1026,var_867);
            return;
         }
         var_17 = new BitmapData(Math.max(var_232 * _thumbWidth,var_1026),Math.max(var_503 * var_90,var_867),true,16777215);
         var_17.fillRect(var_17.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_503)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_232 && var_17.height < _loc3_.y * var_90)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_232 - 1),var_90);
         _loc2_.copyPixels(var_17,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_232 - 1),0,_thumbWidth,var_17.height);
         _loc2_.copyPixels(var_17,_loc4_,new Point(0,var_90),null,null,true);
         _loc4_ = new Rectangle(0,var_90,_thumbWidth * (var_232 - 1),0 - var_90);
