package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_290:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_229,onObjectPlaced);
         var_511 = new Timer(const_1122,1);
      ...
      {
         return var_47.getSubCategoryViewId() == InventorySubCategory.const_274;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_416.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_416.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_683)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_229,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_288)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_274:
               ...
               break;
            case InventorySubCategory.const_951:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_47.checkCategoryInitilization(InventoryCategory.const_421);
      ...
      {
         if(var_887 && param1.type == RoomEngineObjectEvent.const_229)
         {
            var_47.showView();
            var_887 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_294 || _loc3_.category == FurniCategory.const_297 || _loc3_.category == FurniCategory.const_288)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_416.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_416 = new Map();
         var_416.add(const_42,new Array());
         var_416.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
