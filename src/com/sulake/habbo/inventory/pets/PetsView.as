package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_488 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_610 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_610.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_610.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_488.removeGridItem(_loc2_.window);
         if(var_313 == _loc2_)
         {
            var_313 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_610.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_488.addGridItem(_loc2_.window);
            var_610.add(param1.id,_loc2_);
            if(var_313 == null)
            {
               selectFirst();
            }
