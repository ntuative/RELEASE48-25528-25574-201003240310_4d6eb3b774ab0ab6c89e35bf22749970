package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1196 && param1.type == RoomEngineObjectEvent.const_229)
         {
            var_47.showView();
            var_1196 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1196 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_35,RoomObjectTypeEnum.const_337,_loc3_.figure);
            var_47.closeView();
            return;
         }
      ...
      {
         if(var_991.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
