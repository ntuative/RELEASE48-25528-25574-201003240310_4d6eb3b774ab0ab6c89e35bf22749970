package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1627:int = 8947848;
      ...
      private const const_1414:Number = 0.2;
      
      protected var var_1375:Boolean;
      
      private const const_1413:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_683)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1494));
         }
         else
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1414;
               _loc1_.blend = const_1414;
            }
            else
            {
               _window.blend = const_1413;
               _loc1_.blend = const_1413;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1375 && getRecyclableCount() > 0)
            {
