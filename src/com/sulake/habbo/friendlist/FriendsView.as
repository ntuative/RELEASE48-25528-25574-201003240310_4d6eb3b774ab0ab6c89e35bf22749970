package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_2234:IContainerButtonWindow;
      
      private var var_2235:IContainerButtonWindow;
      
      private var var_2233:IContainerButtonWindow;
      ...
      {
         var_2234 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_2235 = initButton("open_homepage",onHomeButtonClick,param1);
         var_2232 = initButton("room_invite",onInviteButtonClick,param1);
         var_2233 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_2234,isEnableMinimailButton(_loc1_));
         setEnabled(var_2235,isEnableHomeButton(_loc1_));
         setEnabled(var_2232,isEnableInviteButton(_loc1_));
         setEnabled(var_2233,isEnableRemoveButton(_loc1_));
      }
