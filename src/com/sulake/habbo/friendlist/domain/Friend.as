package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1619:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_743 = param1.gender;
         var_676 = param1.online;
         var_1142 = param1.followingAllowed && param1.online;
         var_427 = param1.figure;
         var_1328 = param1.motto;
         var_1326 = param1.lastAccess;
         var_1272 = param1.categoryId;
         var_1327 = param1.realName;
