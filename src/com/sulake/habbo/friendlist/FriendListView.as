package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1433:String = "noconvinfo";
      ...
      private var var_1275:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1275 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_826 = IWindowContainer(var_13.content.findChildByName("main_content"));
         var_282 = IWindowContainer(var_13.content.findChildByName("footer"));
         var_1275.prepare(var_826);
         var_13.procedure = onWindow;
         var_13.content.setParamFlag(HabboWindowParam.const_1003,false);
         var_13.content.setParamFlag(HabboWindowParam.const_1319,true);
         var_13.header.setParamFlag(HabboWindowParam.const_666,false);
         var_13.header.setParamFlag(HabboWindowParam.const_817,true);
         var_13.content.setParamFlag(HabboWindowParam.const_666,false);
         var_13.content.setParamFlag(HabboWindowParam.const_817,true);
         var_13.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1276 = ITextWindow(var_13.findChildByName("info_text"));
         var_1276.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_13.scaler.setParamFlag(HabboWindowParam.const_956,this._friendList.tabs.findSelectedTab() != null);
         var_13.scaler.setParamFlag(HabboWindowParam.const_666,false);
         var_13.scaler.setParamFlag(HabboWindowParam.const_1003,false);
         var_13.scaler.x = 0 - var_13.scaler.width;
         var_13.scaler.y = 0 - var_13.scaler.height;
         var_1513 = var_13.height;
         var_1514 = var_13.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1513 == -1 ? 0 : int(0 - var_1513);
         var _loc4_:int = var_1514 == -1 ? 0 : int(0 - var_1514);
