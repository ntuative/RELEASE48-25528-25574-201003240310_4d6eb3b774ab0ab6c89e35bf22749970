package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_766:IAvatarRenderManager;
      ...
      private var var_767:FriendRequests;
      
      private var var_1615:int;
      
      var var_88:FriendCategories;
      
      private var var_1616:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_765:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1616 = new FriendListLookAndFeel();
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_767.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_767.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_394.findTab(FriendListTab.const_82).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_767 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_88.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_88.addCategory(new FriendCategory(FriendCategory.const_997,getText("friendlist.friends")));
         var_88.addCategory(new FriendCategory(FriendCategory.const_407,getText("friendlist.friends.offlinecaption")));
         ...
         if(!var_451)
         {
            var_451 = new Timer(120000);
            var_451.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_451.start();
         }
         getBuddyRequests();
         registerListeners();
         var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_451.stop();
            var_451.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_451 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_766)
         {
            var_766.release(new IIDAvatarRenderManager());
            var_766 = null;
         }
         if(var_765)
         {
            var_765.release(new IIDHabboNotifications());
            var_765 = null;
         }
         if(var_192)
         {
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_767.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_394.findTab(FriendListTab.const_82);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_766.createAvatarImage(param1,AvatarScaleType.const_94);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_767.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_394.findTab(FriendListTab.const_82);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_766 = param2 as IAvatarRenderManager;
      ...
      {
         var_765 = param2 as IHabboNotifications;
