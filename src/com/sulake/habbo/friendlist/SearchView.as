package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      private var var_653:ITextFieldWindow;
      ...
      {
         var_653 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_653.procedure = onSearchInput;
         var_653.addEventListener(WindowKeyboardEvent.const_137,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_48.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_304,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_653.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
