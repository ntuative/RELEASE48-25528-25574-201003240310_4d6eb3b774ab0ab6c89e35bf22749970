package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1410:ICoreWindowManager;
      ...
      {
         var_1410 = param2 as ICoreWindowManager;
         _window = var_1410.create("Logger::Output",HabboWindowType.const_476,WindowStyle.const_298,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_334 = var_1410.create("Logger::Output::Text",HabboWindowType.const_2,WindowStyle.const_298,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
