package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1055:uint = 1;
       
      
      private var var_649:ISkinContainer;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_649 = new SkinContainer(_loc3_.content as XML,assets);
         var_648 = new WindowRenderer(var_649);
         var_212 = new Array(const_341);
         var _loc5_:int = 0;
         while(_loc5_ < const_341)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_648,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_212[_loc5_] = _loc4_;
            _loc5_++;
         }
         _windowContext = var_212[const_1055];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_317,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         _windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1184,_loc6_);
      }
      ...
      {
         return var_212[param1].getDesktopWindow().getChildAt(_windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1140 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1140 = new ProfilerOutput(_loc3_,this,var_648);
      ...
      {
         return var_649.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1323,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1143,param2.name + ": " + param2.toString());
            }
         }
      }
   }
