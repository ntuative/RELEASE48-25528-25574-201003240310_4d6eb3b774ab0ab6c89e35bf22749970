package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1577:CutToHeight = new CutToHeight();
      
      private static var var_1576:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1577.beforeSearch(param2,param1,param3);
         binarySearch(var_1577,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1576.beforeSearch(param2,param1,param3);
         binarySearch(var_1576,param2.length - 1);
      }
   }
}
