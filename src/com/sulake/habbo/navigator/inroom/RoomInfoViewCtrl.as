package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomInfoViewCtrl implements IRoomSettingsCtrlOwner
   {
      ...
      private var var_644:ITextWindow;
      ...
      private function refreshEventButtons(param1:RoomEventData) : void
      {
         ...
         var_1525.visible = param1 == null && _navigator.data.currentRoomOwner;
         var_1526.visible = param1 != null && (_navigator.data.currentRoomOwner || _navigator.data.eventMod);
         var_1528.visible = Util.hasVisibleChildren(var_1528);
      }
      ...
      private function refreshRoomDetails(param1:GuestRoomData, param2:Boolean) : void
      {
         ...
         var_644.text = param1.roomName;
         var_644.height = NaN;
         _ownerName.text = param1.ownerName;
         var_876.text = param1.description;
         var_810.refreshTags(var_362,param1.tags);
         ...
         var_2069.visible = _loc3_;
         var_875.visible = !_loc3_;
         var_1527.visible = !_loc3_;
         var_1527.text = "" + _navigator.data.currentRoomRating;
         ...
         Util.moveChildrenToColumn(var_362,["room_name","owner_name_cont","tags","room_desc","rating_cont"],var_644.y,0);
      ...
      {
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_392,HabboToolbarIconEnum.ROOMINFO,_window,false));
      }
      ...
      private function refreshRoomButtons(param1:Boolean) : void
      {
         ...
         var_1529.visible = _navigator.data.canEditRoomSettings;
         ...
         var_1287.visible = _navigator.data.canEditRoomSettings && param1;
         var_1291.visible = Util.hasVisibleChildren(var_1291);
      }
      ...
      private function refreshRoom() : void
      {
         ...
         this.var_200.refresh(var_310);
         this.var_273.refresh(var_310);
      ...
      private function refreshPublicSpaceDetails(param1:PublicRoomShortData) : void
      {
         ...
         var_1037.height = NaN;
         var_1288.text = _navigator.getPublicSpaceDesc(param1.unitPropertySet,param1.worldId);
         var_1288.height = NaN;
         Util.moveChildrenToColumn(var_719,["public_space_name","public_space_desc"],var_1037.y,0);
         var_719.visible = true;
         var_719.height = Math.max(86,Util.getLowestPoint(var_719));
      }
      ...
      private function prepareWindow() : void
      {
         ...
         _window.setParamFlag(HabboWindowParam.const_1369,true);
         _window.visible = false;
         var_310 = IWindowContainer(find("room_info"));
         var_362 = IWindowContainer(find("room_details"));
         var_719 = IWindowContainer(find("public_space_details"));
         var_2072 = IWindowContainer(find("owner_name_cont"));
         var_2070 = IWindowContainer(find("rating_cont"));
         var_1291 = IWindowContainer(find("room_buttons"));
         var_644 = ITextWindow(find("room_name"));
         var_1037 = ITextWindow(find("public_space_name"));
         _ownerName = ITextWindow(find("owner_name"));
         var_876 = ITextWindow(find("room_desc"));
         var_1288 = ITextWindow(find("public_space_desc"));
         var_1039 = ITextWindow(find("owner_caption"));
         var_875 = ITextWindow(find("rating_caption"));
         var_2069 = ITextWindow(find("rate_caption"));
         var_1527 = ITextWindow(find("rating_txt"));
         var_274 = IWindowContainer(find("event_info"));
         var_877 = IWindowContainer(find("event_details"));
         var_1528 = IWindowContainer(find("event_buttons"));
         var_2071 = ITextWindow(find("event_name"));
         var_720 = ITextWindow(find("event_desc"));
         var_1286 = IContainerButtonWindow(find("add_favourite_button"));
         var_1289 = IContainerButtonWindow(find("rem_favourite_button"));
         var_1292 = IContainerButtonWindow(find("make_home_button"));
         var_1287 = IContainerButtonWindow(find("unmake_home_button"));
         var_1529 = IButtonWindow(find("room_settings_button"));
         var_1525 = IButtonWindow(find("create_event_button"));
         var_1526 = IButtonWindow(find("edit_event_button"));
         var_874 = IWindowContainer(find("embed_info"));
         var_1290 = ITextWindow(find("embed_info_txt"));
         var_1038 = ITextFieldWindow(find("embed_src_txt"));
         Util.setProcDirectly(var_1286,onAddFavouriteClick);
         Util.setProcDirectly(var_1289,onRemoveFavouriteClick);
         Util.setProcDirectly(var_1529,onRoomSettingsClick);
         Util.setProcDirectly(var_1292,onMakeHomeClick);
         Util.setProcDirectly(var_1287,onUnmakeHomeClick);
         Util.setProcDirectly(var_1525,onEventSettingsClick);
         ...
         _navigator.refreshButton(var_1287,"home",true,null,0);
         _window.findChildByName("close").procedure = onCloseButtonClick;
         Util.setProcDirectly(var_310,onHover);
         Util.setProcDirectly(var_274,onHover);
         var_1039.width = var_1039.textWidth;
         Util.moveChildrenToRow(var_2072,["owner_caption","owner_name"],var_1039.x,var_1039.y,3);
         var_875.width = var_875.textWidth;
         Util.moveChildrenToRow(var_2070,["rating_caption","rating_txt"],var_875.x,var_875.y,3);
         var_1290.height = NaN;
         Util.moveChildrenToColumn(var_874,["embed_info_txt","embed_src_txt"],var_1290.y,2);
         var_874.height = Util.getLowestPoint(var_874) + 5;
         var_2316 = NaN;
      }
      ...
      private function refreshEventDetails(param1:RoomEventData) : void
      {
         ...
         var_2071.text = param1.eventName;
         var_720.text = param1.eventDescription;
         var_810.refreshTags(var_877,[_navigator.getText("roomevent_type_" + param1.eventType),param1.tags[0],param1.tags[1]]);
         var_720.visible = false;
         if(param1.eventDescription != "")
         {
            var_720.height = NaN;
            var_720.y = Util.getLowestPoint(var_877) + 2;
            var_720.visible = true;
         }
         var_877.visible = true;
         var_877.height = Util.getLowestPoint(var_877);
      }
