package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_241,Tabs.const_324);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_241,Tabs.const_713);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_241,Tabs.const_324,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_484 == null)
         {
            var_484 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_484.procedure = onChangeFilter;
