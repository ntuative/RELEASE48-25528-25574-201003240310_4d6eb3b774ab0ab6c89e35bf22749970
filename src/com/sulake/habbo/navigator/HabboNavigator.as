package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2364:Dictionary;
      ...
      private var var_821:RoomCreateViewCtrl;
      
      private var var_1843:RoomThumbnailRenderer;
      ...
      private var var_1046:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_575 = new RoomInfoViewCtrl(this);
         var_821 = new RoomCreateViewCtrl(this);
         var_1843 = new RoomThumbnailRenderer(this);
         var_1046 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_255.startSearch(Tabs.const_205,Tabs.const_335,param1);
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_192.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_820)
         {
            var_820.release(new IIDSessionDataManager());
            var_820 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_192 != null)
         {
            var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_192.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1094 = new IncomingMessages(this);
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_255.startSearch(Tabs.const_261,Tabs.const_196);
         var_394.getTab(Tabs.const_261).tabPageDecorator.tabSelected();
      }
