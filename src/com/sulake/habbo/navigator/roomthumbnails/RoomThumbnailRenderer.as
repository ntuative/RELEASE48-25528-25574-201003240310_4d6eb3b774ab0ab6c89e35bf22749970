package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_793:int = 32;
      
      private static const const_1136:int = 8;
      
      public static const const_474:int = 10;
      
      private static const const_1135:int = 40;
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_917.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1134,_loc4_.y + const_1135 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2190[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_917.getImage(ThumbnailEditorModel.const_38,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_917.getImage(ThumbnailEditorModel.const_38,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_917.getImage(ThumbnailEditorModel.const_53,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_793 / 2);
         return new Point(param1 * const_793 + _loc3_,param2 * const_1136);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_474)
         {
            var_1081[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1081[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_474)
         {
            if(false)
            {
               refreshObj(param1,var_1081[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1351 == null)
         {
            var_1351 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1351,var_1351.rect,new Point(0,0),null,null,true);
      }
   }
}
