package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1497,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1496,this._model.mode != ThumbnailEditorModel.const_33);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1497 = IButtonWindow(find("top_tab"));
         var_1496 = IButtonWindow(find("obj_tab"));
         var_1988 = IWindowContainer(find("tile_grid"));
         var_1987 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1497,onTopTabButton);
         Util.setProcDirectly(var_1496,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_474)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1987;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_57,HabboWindowStyle.const_39,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
