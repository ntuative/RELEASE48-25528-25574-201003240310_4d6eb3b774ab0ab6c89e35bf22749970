package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            ...
            case CantConnectMessageParser.const_1221:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1355:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_113,HabboToolbarIconEnum.ROOMINFO));
            setToolbarExitIcon();
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_157 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_131 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
