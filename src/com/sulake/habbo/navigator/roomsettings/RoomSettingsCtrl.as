package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1301:TextFieldManager;
      ...
      private var var_1302:ICheckBoxWindow;
      ...
      private var var_1046:TextFieldManager;
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1301.clearErrors();
         this.var_906.clearErrors();
         this.var_907.clearErrors();
         this.var_1046.clearErrors();
      ...
      private function populateForm() : void
      {
         ...
         var_1301.setText(_loc1_.description);
         var_1046.setText("");
         var_1300.setText("");
         ...
         changePasswordField(_loc1_.doorMode == RoomSettingsData.const_131);
         ...
         if(var_1302)
         {
            if(_loc1_.allowPets)
            {
               this.var_1302.select();
            }
            else
            {
               this.var_1302.unselect();
            }
         }
         if(var_1296)
         {
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         if(_navigator.data.guestRoomSearchResults != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(_navigator.tabs.getSelected().id,_loc3_.method_1,_loc3_.searchParam);
         }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_57,HabboWindowStyle.const_39,HabboWindowParam.const_67,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1533.visible = _inRoom;
         var_1532.visible = _inRoom;
         var_2078.visible = var_510;
         var_2077.visible = !var_510;
         if(var_510)
         {
            var_1047.visible = true;
            var_1297.visible = false;
         ...
         {
            populateForm();
            var_1044.visible = true;
            var_1297.visible = true;
            var_1299.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1299.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1044.height = Util.getLowestPoint(this.var_1044) + 4;
         }
         var_1534.text = !!var_510 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1533.name,var_1299.name,var_1044.name,var_1047.name,var_1297.name,var_1532.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1301.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_381;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_131)
         {
            _loc8_ = var_1046.getText();
            _loc9_ = var_1300.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1046.clearErrors();
         ...
         _loc2_.allowPets = var_1302.isSelected;
         _loc2_.allowFoodConsume = var_1296.isSelected;
         _loc2_.allowWalkThrough = var_1298.isSelected;
         _loc2_.tags = new Array();
         addTag(var_906,_loc2_.tags);
         addTag(var_907,_loc2_.tags);
         this.clearErrors();
         this.var_1045 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_413 || var_1045 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1243)
         {
            this.var_1301.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         {
            this.var_1046.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_857,onDoorModePasswordUnselect);
         ...
         this.var_1301 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         ...
         this.var_1046 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1300 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1302 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1296 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1298 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1533 = IWindowContainer(_window.findChildByName("header_container"));
         var_1299 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1044 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1047 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1532 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1297 = IWindowContainer(_window.findChildByName("footer_container"));
         var_275 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1043 = IWindowContainer(_window.findChildByName("password_container"));
         var_2077 = ITextWindow(_window.findChildByName("basic_caption"));
         var_2078 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1534 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1534.procedure = onSwitchView;
         var_1043.visible = false;
         if(!_inRoom)
         {
