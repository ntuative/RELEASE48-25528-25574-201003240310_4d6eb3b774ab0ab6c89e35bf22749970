package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_764:BitmapData = null;
      ...
      private var var_763:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_444,0,0,_loc4_,var_1388,var_763,var_764));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1613 = int(_config.getKey("interstitial.interval","30000"));
         var_1612 = int(_config.getKey("interstitial.show.time","5000"));
         var_1387 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1115 = _loc2_.imageUrl;
         var_1388 = _loc2_.clickUrl;
         if(var_1115 != "" && var_1388 != "")
         {
            _loc3_ = var_1115;
            ...
            _loc4_ = new URLRequest(var_1115);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1116 = _loc2_.imageUrl;
         var_1611 = _loc2_.clickUrl;
         var_635 = getTimer();
         if(var_1116 != "")
         {
            _loc3_ = var_1116;
            ...
            var_210.start();
            _loc4_ = new URLRequest(var_1116);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_382,0,0,param1.bitmapData,var_1611));
            var_635 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_764 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1387 > 0 && var_1389 >= var_1387)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_635;
         if(_loc1_ > var_1613)
         {
            ++var_1389;
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_458));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_763 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
