package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1752:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1752.clone());
      ...
      {
         var_1752 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
