package com.sulake.habbo.moderation
{
   ...
   public class ModerationManager extends Component implements IHabboModeration
   {
      ...
      private var var_1883:ModeratorInitMessageParser;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1880:WindowTracker;
      ...
      private var var_1882:ModerationMessageHandler;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         {
            _connection = param1;
            var_1882 = new ModerationMessageHandler(this);
         }
      }
