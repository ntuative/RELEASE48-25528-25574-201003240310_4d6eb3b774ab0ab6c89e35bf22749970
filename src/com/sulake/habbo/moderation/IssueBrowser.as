package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1422:IIssueBrowserView;
      
      private const const_1643:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1641:String = "picked_issues";
      ...
      private var var_1423:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_219 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_219.numTabItems)
            {
               _loc5_ = var_219.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_219.selector.getSelectableByName("open_issues");
         var_219.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_337.view.width = var_219.container.width;
         var_337.view.height = var_219.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1642:
               if(var_1421 == null)
               {
                  var_1421 = new MyIssuesView(issueManager,this,var_219.container);
               }
               return var_1421;
            case const_1643:
               if(var_1422 == null)
               {
                  var_1422 = new OpenIssuesView(issueManager,this,var_219.container);
               }
               return var_1422;
            case const_1641:
               if(var_1423 == null)
               {
                  var_1423 = new PickedIssuesView(issueManager,this,var_219.container);
               }
               return var_1423;
            default:
               return null;
