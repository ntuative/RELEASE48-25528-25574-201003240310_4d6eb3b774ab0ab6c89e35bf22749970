package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_699:OffenceCategoryData;
      ...
      private var var_698:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         var_850 = IButtonWindow(_main.getXmlWindow("modact_offencectg"));
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_849.selection < 0)
         {
            _main.windowManager.alert("Alert","You must select ban lenght",0,onAlertClose);
            return;
         }
         _main.connection.send(new ModBanMessageComposer(var_1247,var_403.text,getBanLength(),var_1246));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_849.selection;
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModAlertMessageComposer(var_1247,var_403.text,var_1246));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_699 = _main.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.connection.send(new ModKickMessageComposer(var_1247,var_403.text,var_1246));
         this.dispose();
      }
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = var_699 != null;
         if(this.var_698 != null)
         {
            var_52.findChildByName("offence_txt").caption = this.var_698.name;
            var_52.findChildByName("offence_category").visible = true;
         }
         else if(this.var_699 != null)
         {
            this.refreshButtons("offences_cont",2,var_699.offences,var_851,onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,_main.initMsg.offenceCategories,var_850,onOffenceCtgButton);
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         var_698 = var_699.offences[_loc3_];
         var_403.text = var_698.msg;
         var_293 = false;
         this.refreshCategorization();
      }
      ...
      public function show() : void
      {
         ...
         var_52.caption = "Mod action on: " + var_1498;
         ...
         var_849 = IDropMenuWindow(var_52.findChildByName("banLengthSelect"));
         prepareBanSelect(var_849);
