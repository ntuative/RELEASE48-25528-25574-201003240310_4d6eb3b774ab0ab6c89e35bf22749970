package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_1131:String = const_349;
      ...
      public static const const_541:String = "RCL_LOADER_READY";
      ...
      private var var_1075:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         ...
         var_2167 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_425 = new Map();
         _events = new Map();
      ...
      {
         if(var_175 != null && var_175.hasWorldType(const_279 + param1))
         {
            return var_175.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_518.indexOf(_loc14_) < 0)
                              {
                                 var_518.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_425 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_425.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_425.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_611.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_425.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_349,const_496,ROOM_CONTENT,const_786,const_785];
      }
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_178 && _loc5_ != RoomObjectLogicEnum.const_124)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_517.getValue(param1) as String;
      ...
      {
         if(var_612.getValue(param1) != null)
         {
            return var_612.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1389);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2167.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function continueInitilization() : void
      {
         if(var_2163)
         {
            ...
            if(var_1075 != null)
            {
               var_1075.dispatchEvent(new Event(const_541));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_175 != null)
         {
            return var_175.getWorldHeightScale(const_279 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1075 = param1;
            var_2164 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2169 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2168 = param2.getKey("public.room.dynamic.download.url","");
            var_2165 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_31 = const_787;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_178 && _loc5_ != RoomObjectVisualizationEnum.const_124)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_279 + param1) == RoomObjectCategoryEnum.const_63)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_175 = var_1336.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_175 != null)
         {
            return var_175.getWorldScale(const_279 + param1);
         }
         return 32;
      }
