package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_987:int = -1000000000;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_963,_loc3_.status);
         }
      }
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var_73.method_10(_loc7_,_loc8_);
         var _loc9_:* = -1;
         var _loc10_:* = -1;
         var _loc11_:* = 0;
         var _loc12_:* = 0;
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            param1.addMessageEvent(new HeightMapMessageEvent(method_7));
