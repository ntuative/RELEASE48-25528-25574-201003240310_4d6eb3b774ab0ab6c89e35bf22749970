package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_857:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_994);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_932)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_866);
               var_497 = const_1109;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_242);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_286 != _loc3_.getUpdateID() || var_207 != param1.scale || var_158 != _loc4_.getUpdateID();
         ...
         if(_loc15_ || _loc16_)
         {
            ...
            if(var_427 != _loc7_)
            {
               for each(_loc36_ in var_406.getKeys())
               {
                  var_406.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_242);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_560);
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_464);
            if(_loc24_ != null && _loc24_ != "")
            {
               _loc38_ = _loc4_.getNumber(RoomObjectVariableEnum.const_410);
               _loc39_ = 3;
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_378) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1108;
            ...
            _loc31_ = getSprite(const_1648);
            if(_loc10_ > 0)
            {
               _loc29_ = null;
               _loc29_ = var_857.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_856.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_856)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
      ...
      {
         var_857 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
