package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_498 == 0)
         {
            var_498 = _animationData.getStartFrame(var_1062,param1);
         }
         var_498 += 1;
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1062,var_498,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1062,_loc6_,_loc5_.activeSequenceOffset + 1,var_498,param1);
               }
