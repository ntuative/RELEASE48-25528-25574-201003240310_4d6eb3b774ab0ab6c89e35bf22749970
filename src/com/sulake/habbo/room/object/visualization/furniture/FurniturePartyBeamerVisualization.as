package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_759:int = 15;
      
      private static const const_1056:int = 2;
      
      private static const const_344:int = 2;
      
      private static const const_758:int = 31;
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_952 = new Array();
         var_952.push(Math.random() * _loc2_ * 1.5);
         var_952.push(Math.random() * _loc2_ * 1.5);
         var_955 = new Array();
         var_955.push(1);
         var_955.push(-1);
         var_954 = new Array();
         var_954.push(const_1056);
         var_954.push(const_1057);
         var_953 = new Array();
