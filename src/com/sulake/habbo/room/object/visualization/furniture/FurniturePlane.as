   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_2180)
         {
            if(!param1)
            {
               var_281.assign(var_615);
               var_280.assign(var_614);
            }
            else
            {
               var_281.assign(var_615);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_71 == null && var_913 != null || var_281 == null || var_280 == null || var_521 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1341)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_1079 || _loc4_.y != var_1716 || _loc4_.z != var_1715 || param1.scale != var_1719))
            {
               var_1079 = _loc4_.x;
               var_1716 = _loc4_.y;
               var_1715 = _loc4_.z;
