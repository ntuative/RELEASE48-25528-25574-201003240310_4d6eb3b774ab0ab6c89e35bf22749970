package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1426:int = 0;
      ...
      private var var_857:AvatarVisualizationData = null;
      ...
      {
         var_857 = param1 as AvatarVisualizationData;
         createSprites(const_1108);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_406.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_626);
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_292);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_286 != _loc3_.getUpdateID() || var_207 != param1.scale || var_158 != _loc4_.getUpdateID();
         ...
         if(_loc20_ || _loc21_)
         {
            ...
            if(var_427 != _loc7_)
            {
               for each(_loc49_ in var_406.getKeys())
               {
                  var_406.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_857.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_406.remove(_loc5_);
               var_406.add(_loc5_,_loc6_);
               var_427 = _loc7_;
            }
            ...
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_242) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_242);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_560);
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_464);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_410);
               _loc52_ = 3;
            ...
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_821);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1005,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_861);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_825);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_813,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_537);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_553);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_834,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_811);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_944,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_449);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_378) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_616);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_459);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_1010);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_593,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1648);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_839))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_857.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_856.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_856)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_406 != null)
         {
            _loc1_ = var_406.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_406.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
