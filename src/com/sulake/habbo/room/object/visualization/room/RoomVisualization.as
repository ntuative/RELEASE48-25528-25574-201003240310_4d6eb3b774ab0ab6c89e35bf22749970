package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_762:int = 16777215;
      
      public static const const_1199:int = 10066329;
      
      private static const const_763:int = 13421772;
      
      public static const const_1213:int = 16777215;
      
      private static const const_1410:int = 0;
      
      public static const const_1223:int = 16777215;
      
      private static const const_764:int = 10066329;
      
      private static const const_761:int = 10066329;
      
      public static const const_1170:int = 13421772;
       
      
      private var var_1412:int = 0;
      
      private var var_1363:String = null;
      
      private var var_1723:int = 255;
      ...
      private const const_1640:int = 250;
      ...
      private var var_381:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_381 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_992);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_850);
         var _loc7_:int = 0;
         while(_loc7_ < var_73.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_186,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_185,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1159)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_220,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_381.maskCount)
         {
            _loc6_ = var_381.getMaskType(_loc5_);
            _loc7_ = var_381.getMaskLocation(_loc5_);
            _loc8_ = var_381.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_98.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_220 || _loc3_.type == RoomPlane.const_185 && _loc8_ == RoomPlaneBitmapMaskData.const_231)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1412;
                        if(var_73.getPlaneType(_loc9_) == RoomPlaneData.const_148)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1341)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1079 || _loc9_.y != var_1716 || _loc9_.z != var_1715 || param1.scale != var_1719))
            {
               var_1079 = _loc9_.x;
               var_1716 = _loc9_.y;
               var_1715 = _loc9_.z;
               var_1719 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_863);
            if(_loc10_ != var_1722)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_564));
            if(_loc11_ != var_960)
            {
               var_960 = _loc11_;
               var_1720 = var_960 & 255;
               var_1717 = var_960 >> 8 & 255;
               var_1723 = var_960 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1718 + const_1640 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1718 = _loc7_;
         if(var_158 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_648);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_675);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_592);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1714 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_996));
         ...
         while(_loc8_ < var_382.length)
         {
            ...
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_185)
            {
               if(var_1714)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1720 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1717 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1723 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_98.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_186 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               ...
               else if(_loc5_.type == RoomPlane.const_185 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
