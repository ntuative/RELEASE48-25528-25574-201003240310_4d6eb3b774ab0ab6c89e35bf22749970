package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1467:int = 16777216;
      ...
      private var var_1501:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1501 * param2);
      }
      ...
      {
         var _loc1_:int = var_2340 * var_1255 + var_2341;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
