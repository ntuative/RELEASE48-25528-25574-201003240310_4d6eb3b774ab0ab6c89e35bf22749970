         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               ...
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1363,_loc4_.race);
               }
               ...
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_464,_loc8_.gesture);
               ...
               if(param1 is RoomObjectAvatarChatUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_626,_loc9_.numberOfWords);
               ...
               if(param1 is RoomObjectAvatarPostureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_242,_loc10_.postureType);
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_866,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
