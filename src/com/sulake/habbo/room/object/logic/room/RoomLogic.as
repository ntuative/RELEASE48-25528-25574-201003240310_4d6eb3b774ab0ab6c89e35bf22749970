package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1538:int = 1500;
      
      private var var_1536:int = 255;
      
      private var var_1537:int = 255;
      
      private var var_1303:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_457:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_231)
                  {
                     _loc8_ = "null";
                  }
                  var_381.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_718:
                  _loc7_ = var_381.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_381.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_863,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_996,int(_loc5_.bgOnly));
            var_1303 = _color;
            var_1536 = var_1222;
            var_1048 = _loc11_;
            var_1537 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_992,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_564,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1297,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1142,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1298,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_136 || _loc13_ == RoomPlaneData.const_255)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_882)
         {
            ...
            {
               _loc7_ = var_1303 >> 16 & 255;
               _loc8_ = var_1303 >> 8 & 255;
               _loc9_ = var_1303 & 255;
               _loc10_ = var_1048 >> 16 & 255;
               _loc11_ = var_1048 >> 8 & 255;
               _loc12_ = var_1048 & 255;
               _loc13_ = (_loc2_ - var_882) / var_1538;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1536 + (var_1537 - var_1536) * _loc13_;
               _color = _loc3_;
               var_1222 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_564,_loc3_);
         }
      }
   }
}
