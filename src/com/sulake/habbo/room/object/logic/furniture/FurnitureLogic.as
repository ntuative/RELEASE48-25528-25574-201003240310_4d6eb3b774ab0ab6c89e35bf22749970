package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               {
                  _loc2_.setString(RoomObjectVariableEnum.const_432,String(_loc3_.extra));
               }
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            if(_loc2_ != null)
            {
               _loc2_.setString(RoomObjectVariableEnum.const_910,_loc4_.itemData);
            }
            return;
         }
         var_692 = false;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_332,var_1011,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_470,var_1012,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_613,var_1013,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1210,var_1976,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1201,var_1977,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1002,var_1239,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_622,var_235,true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         var _loc9_:String = _loc3_.getString(RoomObjectVariableEnum.const_287);
         switch(param1.type)
         {
