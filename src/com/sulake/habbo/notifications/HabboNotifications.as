package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1102:String = "pet_inventory";
      
      private static const const_1098:String = "pixelbalance";
      
      private static const const_1103:String = "credits";
      
      private static const const_1104:String = "inventory";
      
      private static const const_1100:String = "friendlist";
      
      private static const const_1099:String = "selectfurni";
      
      private static const const_1101:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_585:ParkBusDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_844);
         }
         var _loc6_:Map = var_844["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1289);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1965)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_812);
            var_1965 = true;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_812,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_941,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_153 || param2.type == WindowEvent.const_633)
         {
            param1.dispose();
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_585 == null)
         {
            var_585 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_585 != null)
         {
            var_585.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               if(_loc14_.productType == CatalogPageMessageProductData.const_80)
               {
                  _loc15_ = var_353.getFloorItemData(_loc14_.furniClassId);
               }
               else if(_loc14_.productType == CatalogPageMessageProductData.const_76)
               {
                  _loc15_ = var_353.getWallItemData(_loc14_.furniClassId);
               }
         ...
         if(_loc8_)
         {
            addItem(_loc8_.value,NotificationType.const_1240,_loc5_);
         }
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_584.events.addEventListener(HabboToolbarEvent.const_83,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_353.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_882);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_882);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_83)
         {
            ...
            var_398 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_844["styles"],var_844["view"],var_584);
            ...
            var_353.events.addEventListener(BadgeImageReadyEvent.const_127,onBadgeImage);
