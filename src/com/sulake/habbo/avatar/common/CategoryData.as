package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_658 >= 0 && var_164.length > var_658)
         {
            _loc2_ = var_164[var_658];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_164.length > param1)
         {
            _loc3_ = var_164[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      {
         return var_164[var_658] as AvatarEditorGridPartItem;
      }
