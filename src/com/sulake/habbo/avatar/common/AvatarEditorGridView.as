package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
         ...
         if(param1.type == WindowMouseEvent.const_50)
         {
            ...
            while(_loc7_ < const_1072)
            {
               if(var_405.length > _loc7_)
               {
                  ...
                  if(_loc5_ > -1)
                  {
                     _model.selectColor(var_1272,_loc5_,_loc7_);
                     return;
                  }
               }
               _loc7_++;
      ...
      public function initFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:CategoryData = _model.getCategoryData(var_1272);
         if(!_loc1_)
         {
            return;
         }
      ...
      private function partEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_50)
         {
            ...
            _model.selectPart(var_1272,_loc3_);
         }
      }
