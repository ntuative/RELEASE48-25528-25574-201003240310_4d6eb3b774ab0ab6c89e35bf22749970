package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_808:AvatarEditorHandler;
      
      private var var_388:Map;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_820:ISessionDataManager;
      ...
      private const const_1072:int = 2;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_667.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_160)
         {
            ...
            var_88 = new Map();
            var_388 = new Map();
            var_88.add(AvatarEditorFigureCategory.const_848,new BodyModel(this));
            var_88.add(AvatarEditorFigureCategory.const_47,new HeadModel(this));
            var_88.add(AvatarEditorFigureCategory.const_289,new TorsoModel(this));
            var_88.add(AvatarEditorFigureCategory.const_1194,new LegsModel(this));
            var_88.add(AvatarEditorFigureCategory.const_1395,new HotLooksModel(this));
            var_388.add(AvatarEditorSideCategory.WARDROBE,new WardrobeModel(this));
            var_388.add(AvatarEditorSideCategory.const_436,new ClubPromoModel(this));
            var_160 = true;
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_820 = param2 as ISessionDataManager;
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_977 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc13_ = isClubTryoutAllowed() && var_1438;
            for each(_loc14_ in _loc10_.colors)
            {
               if(_loc14_.isSelectable && (_loc13_ || var_977 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1072)
                  {
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1370.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1265)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_977 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1370.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_388.getValue(AvatarEditorSideCategory.WARDROBE);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_808 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_667.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = var_388.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(_windowContext == null)
            {
               _windowContext = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_57,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorFigureCategory.const_848);
         return true;
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_667 = var_563.getFigureData(AvatarType.const_81);
      }
