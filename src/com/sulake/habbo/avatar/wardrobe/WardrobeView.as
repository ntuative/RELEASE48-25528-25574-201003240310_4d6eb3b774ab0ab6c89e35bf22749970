package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_1028:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_709 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1028 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_709)
         {
            var_709.removeListItems();
         }
         if(var_1028)
         {
            var_1028.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_709)
               {
                  var_709.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1028)
            {
               var_1028.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
