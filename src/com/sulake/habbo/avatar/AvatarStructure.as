package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1980:PartOffsetData;
      
      private var var_845:AvatarActionManager;
      
      private var var_168:IAssetLibrary;
      
      private var var_1014:IAssetLibrary;
      
      private var var_1371:Boolean = false;
      
      private var var_1979:AvatarRenderManager;
      
      private var var_400:FigureData;
      ...
      private var var_694:AnimationManager;
      ...
      {
         return var_845.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_845.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_400.append(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_845.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_694.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1387[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_845.getDefaultActionType();
         var _loc9_:Array = var_401.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_694.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_400.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_400.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        if(_loc14_.indexOf(_loc28_.type) > -1)
                        {
                           ...
                           _loc13_ = var_401.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_401.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_693 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_693)
         {
            case AvatarType.const_81:
               ...
               var_1495.add(new AvatarStructureDownload(var_168,_loc5_,var_400));
               break;
            case AvatarType.PET:
         }
      ...
      {
         return var_694.getAnimation(param1);
      }
      ...
      {
         var_845 = new AvatarActionManager(var_168,var_693);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1014.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1014.getAssetByName("dance" + _loc1_).content as XML;
            var_694.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1014.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1014.getAssetByName("fx" + _loc1_).content as XML;
            var_694.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_400.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_400.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_845.sortActions(param1);
      }
   }
}
