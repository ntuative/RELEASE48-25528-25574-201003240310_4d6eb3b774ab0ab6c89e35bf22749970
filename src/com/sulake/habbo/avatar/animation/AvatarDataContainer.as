package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_2135 = parseInt(_loc2_,16);
         var_2136 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1591,var_1590,var_1592,_alphaMultiplier);
         var_1072 = generatePaletteMapForGrayscale(var_2136,var_2135);
      }
