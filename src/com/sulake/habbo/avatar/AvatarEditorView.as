package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1454:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_481:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         var_341 = new Timer(1000);
         var_341.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1454 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         update();
      }
      ...
      public function update() : void
      {
         ...
         if(var_47.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1456 == AvatarEditorSideCategory.WARDROBE || var_1831))
         {
            _loc4_ = "null";
         }
      ...
      public function dispose() : void
      {
         ...
         {
            var_341.stop();
            var_341.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_341 = null;
         }
      }
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_481)
         {
            ...
            var_481 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_481.procedure = stripClubDialogEventProc;
            var_481.center();
         }
         else
         {
            var_481.visible = true;
            var_481.center();
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_619:
               break;
            case AvatarEditorSideCategory.const_436:
               _loc3_ = var_47.getSideContentWindowContainer(AvatarEditorSideCategory.const_436);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_253 = param1;
         var_1454.setSelected(var_1454.getSelectableByName(param1));
         _window.invalidate();
      }
      
      private function toggleWardrobe() : void
      {
         if(var_1456 == AvatarEditorSideCategory.WARDROBE)
         {
            var_1831 = false;
