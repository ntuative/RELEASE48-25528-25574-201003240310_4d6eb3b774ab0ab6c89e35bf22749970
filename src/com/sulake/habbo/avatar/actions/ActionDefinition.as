package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1918 = parseInt(param1.@precedence);
         var_1924 = String(param1.@activepartset);
         var_1923 = String(param1.@assetpartdefinition);
         var_1919 = String(param1.@lay);
         var_1163 = String(param1.@geometrytype);
         var_1920 = Boolean(parseInt(param1.@main));
         var_1922 = Boolean(parseInt(param1.@MarketplaceCancelOfferResultParser));
         var_1921 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "MarketplaceCancelOfferResultParser")
            {
               var_1925 = _loc6_;
            }
            else
            {
               var_1485[_loc5_] = _loc6_;
            }
         }
      ...
      {
         return var_1229.concat(getTypePrevents(param1));
      }
