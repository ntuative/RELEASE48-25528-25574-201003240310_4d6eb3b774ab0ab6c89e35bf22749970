package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1084 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_618 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_618 && var_1084)
         {
            var_618.bitmap = new BitmapData(var_618.width,var_618.height,true,16777215);
            var_618.bitmap.copyPixels(var_1084,var_1084.rect,new Point(0,0 - 0 - 8));
            var_618.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
