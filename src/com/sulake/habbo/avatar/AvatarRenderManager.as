package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1359:AssetAliasCollection;
      ...
      private function init() : void
      {
         ...
         var_1359 = new AssetAliasCollection(_loc1_,_loc3_);
      ...
      {
         var_660 = param1;
         if(var_660 == RenderMode.const_1182)
         {
            init();
         }
         if(var_660 == RenderMode.const_1218)
         {
            init();
      ...
      {
         return var_1359.getAssetByName(param1);
      }
      ...
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         ...
         return new AvatarImage(_loc6_,var_1359,_loc5_,param4,AvatarType.PET);
      }
      ...
      public function createAvatarImage(param1:String, param2:String) : IAvatarImage
      {
         ...
         return new AvatarImage(_loc3_,var_1359,param1,param2,AvatarType.const_81);
      }
