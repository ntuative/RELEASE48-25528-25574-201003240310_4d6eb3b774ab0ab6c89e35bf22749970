package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_585,var_807);
      ...
      {
         hideInterface();
         var_807 = param1.objectId;
         var_1168 = param1.creditValue;
         showInterface();
      }
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(var_1168));
         ...
         _window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_57,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1071,const_1070,2,2),null,0) as IWindowContainer;
