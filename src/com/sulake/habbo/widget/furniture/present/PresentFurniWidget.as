package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_370,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_462,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_370,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_462,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_62:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_370:
               if(!var_228)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_462:
               if(!var_228)
               {
                  return;
               }
      ...
      private function sendOpen() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_559,var_153);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_57,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1071,const_1070,2,2),null,0) as IWindowContainer;
