package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_495:int = 6;
      
      private static const const_347:int = 10;
      
      private static const const_1119:Number = 18;
      
      private static const const_1436:Number = 10;
      
      private static const const_1437:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1051,var_1050,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1051,var_724,var_1050,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1307 = param1.chatType;
         var_1051 = param1.userId;
         var_724 = param1.userName;
         var_1050 = param1.userCategory;
         _message = param1.text;
         var_1306 = param1.userX;
         var_201 = param1.userImage;
         var_1052 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1052 != 0)
            {
               _loc30_ = uint(var_1052 >> 16 & 255);
               _loc31_ = uint(var_1052 >> 8 & 255);
               _loc32_ = uint(var_1052 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1307 == RoomWidgetChatUpdateEvent.const_247)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_724);
            }
            else if(var_1307 == RoomWidgetChatUpdateEvent.const_249)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_724);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_415;
            _loc20_.width = _loc20_.textWidth + const_495;
            _width += _loc20_.textWidth + const_495;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_347 + _loc20_.textWidth + const_495;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1051,var_1050,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1051,var_1050,_roomId,_roomCategory,param1);
      }
