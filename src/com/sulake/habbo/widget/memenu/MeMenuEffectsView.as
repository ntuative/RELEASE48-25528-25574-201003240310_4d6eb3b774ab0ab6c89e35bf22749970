package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuEffectsView implements IMeMenuView
   {
      ...
      public static const const_862:Number = 55;
      ...
      public function selectEffect(param1:EffectView) : void
      {
         ...
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_604,param1.effect.type));
         }
         else
         {
            _widget.messageListener.processWidgetMessage(new RoomWidgetSelectEffectMessage(RoomWidgetSelectEffectMessage.const_508,param1.effect.type));
         }
      }
      ...
      public function updateEffects(param1:Array) : Boolean
      {
         ...
         for each(_loc3_ in param1)
         {
            ...
            var_577.push(_loc6_);
            _loc6_.window.y = _loc2_ * const_862;
            _loc2_++;
         }
         _loc4_ = 0;
         _loc5_ = 0 * const_862;
