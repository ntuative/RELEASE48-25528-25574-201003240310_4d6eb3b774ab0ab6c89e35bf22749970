   ...
   public class EffectView
   {
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_901 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_174.duration);
               var_901.width = _loc2_ * var_433;
            }
            else
            {
               var_901.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_900 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_901 = _window.findChildByName("loader_bar");
         if(var_901 != null)
         {
            var_433 = var_901.width;
            var_172.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_174.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_900 != null)
         {
            var_900.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_900.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
