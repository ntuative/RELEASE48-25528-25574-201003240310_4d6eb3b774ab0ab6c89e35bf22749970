package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1434:uint = 0;
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         populate(_items,var_1516);
      }
      
      private function highlightItem(param1:int) : void
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_714)
         {
            return;
         }
         if(var_714 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_714) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_714 % 2) ? uint(const_1434) : uint(const_1435);
            }
         }
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(const_1434) : uint(const_1435);
