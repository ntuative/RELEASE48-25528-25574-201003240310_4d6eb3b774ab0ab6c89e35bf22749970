package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1428:String = "infostand_user_view";
      
      private var var_307:InfoStandPetView;
      
      private var var_1143:InfoStandPetData;
      
      private var var_132:Timer;
      
      private var var_859:InfoStandFurniView;
      
      private var var_416:InfostandFurniData;
      ...
      private const const_1427:String = "infostand_furni_view";
      
      private const const_1649:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_859 = new InfoStandFurniView(this,const_1427);
         var_197 = new InfoStandUserView(this,const_1428);
         var_307 = new InfoStandPetView(this,const_1429);
         var_355 = new InfoStandBotView(this,const_1430);
         var_402 = new InfostandUserData();
         var_416 = new InfostandFurniData();
         var_1143 = new InfoStandPetData();
         var_132 = new Timer(const_1649);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_197.setTags(param1.tags,var_2010);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_277,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_587,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_570,onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_146,onPetInfo);
         param1.addEventListener(RoomWidgetPetCommandsUpdateEvent.const_139,onPetCommands);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_412,var_307.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_277,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_587,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_570,onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_146,onPetInfo);
         param1.removeEventListener(RoomWidgetPetCommandsUpdateEvent.const_139,onPetCommands);
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_355.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_128:
               _loc2_ = param1.id == var_416.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_277:
               if(var_197 != null && false && var_197.window.visible)
               {
                  _loc2_ = param1.id == var_402.userRoomId;
                  break;
               }
               if(var_307 != null && false && var_307.window.visible)
               {
                  _loc2_ = param1.id == var_1143.roomIndex;
                  break;
               }
               if(var_355 != null && false && var_355.window.visible)
               {
                  _loc2_ = param1.id == var_402.userRoomId;
                  break;
               }
      ...
      {
         var_307.updateEnabledTrainingCommands(param1.id,param1.enabledCommands);
      }
