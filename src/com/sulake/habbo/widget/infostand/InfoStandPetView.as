package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1632:String = "level";
      ...
      private const const_1633:uint = 3355443;
      
      private var var_218:IBorderWindow;
      
      private const const_1637:int = 158;
      
      private const const_1636:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_245:PetCommandTool;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_218 != null)
         {
            var_96 = var_218.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_96 == null || var_218 == null || var_59 == null)
         {
            return;
         }
         ...
         var_218.height = NaN;
         _window.width = Math.max(var_218.width,var_59.width);
      ...
      private function openTrainView() : void
      {
         if(var_245 == null)
         {
            var_245 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1143.getValue(var_723) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_245.showWindow(true);
            var_245.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1632,param1.level,param1.levelMax);
         ...
         if(var_245 && var_245.isVisible() && param1.isOwnPet)
         {
            var_245.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_245.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_455,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1637,const_1636,false);
         ...
         _loc5_.fillRect(_loc6_,const_1633);
