package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_495:int = 16;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_2007 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2006 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_704 = new Timer(1000,1);
         var_704.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_854 = new Timer(5000,1);
         var_854.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_137,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_441,onWindowMoved);
         var_1257 = true;
         var_131 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2005 = _loc2_.width + const_495 + _loc6_.width + const_1106;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1107,_loc8_.width) + const_495);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_433);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_433);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_496);
