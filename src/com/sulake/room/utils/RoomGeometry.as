package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_504:Number = 64;
      
      public static const const_976:Number = 32;
      ...
      private var var_2348:Number = 500;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(var_241.x != _loc2_ || var_241.y != _loc3_ || var_241.z != _loc4_)
         {
            ++var_77;
         }
      ...
      {
         if(var_443 != param1 * var_1586)
         {
            var_443 = param1 * var_1586;
            ++var_77;
         }
      }
      ...
      {
         if(var_441 != param1 * var_1587)
         {
            var_441 = param1 * var_1587;
            ++var_77;
         }
      }
      ...
      {
         if(var_444 != param1 * var_1588)
         {
            var_444 = param1 * var_1588;
            ++var_77;
         }
      }
      ...
      {
         return new Vector3d(var_241.x,var_241.y,var_241.z);
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2347 || _loc3_ > var_2348)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_441,0 * var_444,0 * var_443);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_441,0 * var_444,0 * var_443);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_441,param2.y * var_444,param2.z * var_443);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_441,param3.y * var_444,param3.z * var_443);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_441,param4.y * var_444,param4.z * var_443);
