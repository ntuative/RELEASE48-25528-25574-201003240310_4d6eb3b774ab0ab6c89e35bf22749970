package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_765:int = 50;
      ...
      private var var_1781:Number = -10000000;
      
      private var var_1784:Number = -10000000;
      
      private var var_2337:int = 0;
      
      private var var_469:RoomObjectCache;
      
      private var var_664:int;
      
      private var var_249:Sprite;
      ...
      public function update() : void
      {
         if(var_976 == 0)
         {
            checkMouseHits(var_974.x,var_974.y,MouseEvent.MOUSE_MOVE);
         }
         var_976 = 0;
         ++var_1437;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_249 != null)
         {
            var_249.graphics.clear();
         }
         else
         {
            var_249 = new Sprite();
            var_249.name = "mask";
            _master.addChild(var_249);
         }
         var_249.graphics.beginFill(0);
         var_249.graphics.drawRect(0,0,param1,param2);
         var_664 = param1;
         var_663 = param2;
         var_50.graphics.clear();
         var_50.graphics.beginFill(var_2337);
      ...
      {
         var _loc11_:Number = param1 - var_664 / 2;
         var _loc12_:Number = param2 - var_663 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_664 != var_1782 || var_663 != var_1783)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         var_662.push(_loc12_ - _loc2_);
         if(var_662.length == const_765)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_765)
            {
               _loc13_ += var_662[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_467.length)
            {
               cleanSprite(var_467[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_467 = [];
         }
         ...
         while(_loc1_ < var_297.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_975 != null)
                  {
                     var_975.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1437,geometry);
                  }
                  else
                  {
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_468.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_468.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1781 || param2 != var_1784)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_468.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_468.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_467.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_469.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_469.getObjectCache(param2);
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_664 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_663))
                  {
