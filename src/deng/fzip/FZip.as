package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_548))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_548,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_92 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_548,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_531.parse(param1))
         {
            ...
            if(false)
            {
               var_138["null"] = var_531;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1314,var_531));
            var_531 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_45 != null && var_138 != null && param1 < var_45.length)
         {
